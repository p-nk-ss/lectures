...
Written so far: **01, 02, 03, 04, 05** — all `status: draft`, each with a review doc, two quizzes and its glossary terms. New lectures repeat Task 12 of `docs/superpowers/plans/2026-08-17-lectures-site.md`.
